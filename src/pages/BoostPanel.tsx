  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto p-4">
        {tab === 'accounts'  && <AccountsTab   uniquedevcode={uniquedevcode} operator={user?.username || ''} />}
        {tab === 'merchants' && <MerchantsTab  uniquedevcode={uniquedevcode} />}
        {tab === 'purchase'  && <PurchaseTab   uniquedevcode={uniquedevcode} operator={user?.username || ''} />}
