// AUTO-GENERATED by scripts/build-legacy-bridge.mjs (v2.11.29).
...
var nativeBridge = function (exports) {
  ...
  const convertFormData = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* (formData) {
      const newFormData = [];
      for (const pair of formData.entries()) {
        const [key, value] = pair;
        if (value instanceof File) {
          const base64File = yield readFileAsBase64(value);
          newFormData.push({
            key,
            value: base64File,
            type: 'base64File',
    ...
    return function convertFormData(_x) {
      return _ref.apply(this, arguments);
    };
  }();
  const convertBody = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(function* (body, contentType) {
      if (body instanceof ReadableStream || body instanceof Uint8Array) {
        ...
        return {
          data: yield convertFormData(body),
          type: 'formData'
        };
      } else if (body instanceof File) {
        const fileData = yield readFileAsBase64(body);
        return {
          data: fileData,
          type: 'file',
          headers: {
    ...
    return function convertBody(_x2, _x3) {
  ...
  const initBridge = w => {
    ...
    const initVendor = (win, cap) => {
      ...
      IonicWebView.setServerAssetPath = path => {
        var _a;
        (_a = Plugins === null || Plugins === void 0 ? void 0 : Plugins.WebView) === null || _a === void 0 ? void 0 : _a.setServerAssetPath({
          path
        });
      };
      IonicWebView.setServerBasePath = path => {
        var _a;
        (_a = Plugins === null || Plugins === void 0 ? void 0 : Plugins.WebView) === null || _a === void 0 ? void 0 : _a.setServerBasePath({
          path
        });
      };
    ...
    const initLogger = (win, cap) => {
      ...
      if (platform == 'android' || platform == 'ios') {
        ...
        win.CapacitorCookiesDescriptor = Object.getOwnPropertyDescriptor(Document.prototype, 'cookie') || Object.getOwnPropertyDescriptor(HTMLDocument.prototype, 'cookie');
        ...
        if (doPatchHttp) {
          ...
          window.fetch = /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator(function* (resource, options) {
              const headers = new Headers(options === null || options === void 0 ? void 0 : options.headers);
              const contentType = headers.get('Content-Type') || headers.get('content-type');
              if ((options === null || options === void 0 ? void 0 : options.body) instanceof FormData && (contentType === null || contentType === void 0 ? void 0 : contentType.includes('multipart/form-data')) && !contentType.includes('boundary')) {
              ...
              if (method.toLocaleUpperCase() === 'GET' || method.toLocaleUpperCase() === 'HEAD' || method.toLocaleUpperCase() === 'OPTIONS' || method.toLocaleUpperCase() === 'TRACE') {
                ...
                if (typeof resource === 'string') {
                  return yield win.CapacitorWebFetch(createProxyUrl(resource, win), options);
                } else if (resource instanceof Request) {
                  const modifiedRequest = new Request(createProxyUrl(resource.url, win), resource);
                  return yield win.CapacitorWebFetch(modifiedRequest, options);
                }
              }
              ...
              try {
                ...
                } = yield convertBody((options === null || options === void 0 ? void 0 : options.body) || body || undefined, optionHeaders['Content-Type'] || optionHeaders['content-type']);
                ...
                const nativeResponse = yield cap.nativePromise('CapacitorHttp', 'request', {
                  url: request.url,
                  method: method,
                  data: requestData,
                  dataType: type,
                ...
                let data = (contentType === null || contentType === void 0 ? void 0 : contentType.startsWith('application/json')) ? JSON.stringify(nativeResponse.data) : nativeResponse.data;
                ...
                convertBody(body).then(({
                  ...
                  cap.nativePromise('CapacitorHttp', 'request', {
                    ...
                    if (this.readyState == 2) {
                      ...
                      this.responseText = ((_a = nativeResponse.headers['Content-Type'] || nativeResponse.headers['content-type']) === null || _a === void 0 ? void 0 : _a.startsWith('application/json')) ? JSON.stringify(nativeResponse.data) : nativeResponse.data;
    ...
    function initNativeBridge(win) {
      ...
      cap.handleWindowError = (msg, url, lineNo, columnNo, err) => {
        ...
        if (str.indexOf('script error') > -1) ;else {
          const errObj = {
            type: 'js.error',
            error: {
              message: msg,
  ...
  initBridge(typeof globalThis !== 'undefined' ? globalThis : typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : {});
  dummy = initBridge;
